...
// ======================= Update Article =======================
function update($db) {
    $stm = $db->prepare("UPDATE `article` SET `name`=:name,`id_size`=:id_size,`id_subcategory`=:id_subcategory,`id_gender`=:id_gender,`id_brand`=:id_brand,`price`=:price,`description`=:description WHERE id =:id");
